...
class Connection:
    ...
    def __init__(self, url, session, auth_token='AA'):
        ...
        self.__transport = AutoTransport(session, self, auth_token)
    ...
    def start(self, **kwargs):
        ...
        if self.auth_token:
            listener = self.__transport.start(token=self.auth_token)
        else:
